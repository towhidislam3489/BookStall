...
const WishCard = ({ eachbook }: IeachbookCard) => {
    return (
        <Link href={`/listbook/${eachbook.bookId}`}>
            <div className="group overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-xl  max-w-[80%] mx-auto grid grid-cols-12 gap-5 mb-20 mt-20">

                <div className="relative h-80 col-span-5 overflow-hidden bg-gray-100 items-center justify-center">
                    <Image
                        src={eachbook.image}
